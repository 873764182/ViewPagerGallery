...
public class Nest2Activity extends AppCompatActivity {
    ...
    private class RecyclerAdapter extends RecyclerView.Adapter<RecyclerViewHolder> {
        ...
        public RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new RecyclerViewHolder(getLayoutInflater().inflate(R.layout.nest_recycler_view2, parent, false));
        }

        @Override
        public void onBindViewHolder(final RecyclerViewHolder holder, final int position) {
            holder.textView.setText(list.get(position));
            holder.recyclerView.setLayoutManager(new LinearLayoutManager(Nest2Activity.this, LinearLayoutManager.VERTICAL, false));
